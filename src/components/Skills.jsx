  ...
  return (
    <>
      <motion.div
        ...
        id="skills"
        className="flex flex-col items-center justify-center md:mt-24 mt-8 gap-5"
      >
        ...
        <div className="flex lg:gap-24 gap-8 flex-wrap w-3/4 mt-10 m-auto pb-20">
          <div className="skill flex flex-col gap-5">
            <p className="font-bold text-2xl bg-gradient-to-r from-pink-700 to-yellow-500 bg-clip-text text-transparent">
          ...
          <div className="skill flex flex-col gap-5">
            ...
            <span>
              {circle} MongoDB (CRUD Operations, Aggregation Framework)
            </span>
          </div>
          <div className="skill flex flex-col gap-5">
            <p className="font-bold text-2xl bg-gradient-to-r from-pink-700 to-yellow-500 bg-clip-text text-transparent">
